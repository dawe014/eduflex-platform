// File: .../_components/chapter-access-form.tsx
"use client";
        ...
        {!isEditing ? (
          <div className="space-y-2">
            ...
            <p className="text-sm text-gray-600">
              {initialData.isFree
                ? "This chapter is available as a free preview for all visitors."
                : "This chapter requires course enrollment to access."}
            </p>
          </div>
        ) : (
          <Form {...form}>
                  ...
                  <FormItem className="flex flex-row items-center justify-between rounded-lg border p-4 bg-gray-50">
                    <div className="space-y-0.5">
                      ...
                      <FormDescription className="text-sm">
                        Enable free preview to allow anyone to access this
                        chapter without enrollment
                      </FormDescription>
                    </div>
                    <FormControl>
                      <Switch
